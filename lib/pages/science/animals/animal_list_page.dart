...
class _AnimalListPageState extends State<AnimalListPage>
  ...
  int _selectedIndex = 0; // State for selected category
  ...
  Future<void> getAnimalTreeList() async {
    ...
    DataUtils.getAnimalPlantTree(
      ...
      success: (data) {
        ...
        setState(() {
          _list =
              rows.where((element) => element.children!.isNotEmpty).toList();
          if (_list.isNotEmpty) {
            _selectedIndex = 0;
          }
          _isLoading = false;
                    ...
                    Expanded(
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          hintText: S.of(context).science_animals_search,
                          hintStyle: TextStyle(
                            fontSize: 14.px,
                            color: const Color(0xFF999999),
                          ),
      ...
      slivers.add(
        SliverToBoxAdapter(
          child: Container(
            ...
            margin: EdgeInsets.only(bottom: 5.px, left: 12.px, right: 12.px),
            decoration: BoxDecoration(
                  ...
                  onTap: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder:
                            (context) =>
                                AnimalDetailPage(fId: item.fId.toString()),
                      ),
                    );
                  },
                  child: Container(
