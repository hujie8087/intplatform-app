...
import 'package:logistics_app/pages/news/employee_page/employee_detail_page.dart';
...
@AppRoute(path: 'employee_list_page', name: '员工风采列表页')
...
class _EmployeeListPageState extends State<EmployeeListPage>
  ...
  void initState() {
    ...
    super.initState();
    getEmployeeModelList(true);
  }

  Future<void> getEmployeeModelList(bool isRefresh) async {
    if (isRefresh) {
      _page = 1;
      _list = [];
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(S.of(context).employee, style: TextStyle(fontSize: 16.px)),
        centerTitle: true,
      ...
      body: SafeArea(
        child: SmartRefreshWidget(
          ...
          enablePullUp: true,
          onRefresh: () {
            getEmployeeModelList(true).then((value) {
              _refreshController.refreshCompleted();
            });
          },
          onLoading: () {
            getEmployeeModelList(false);
          },
