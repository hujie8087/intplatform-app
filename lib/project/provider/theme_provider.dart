...
class ThemeProvider extends ChangeNotifier {
  ...
  void setTheme([ThemeMethod themeMode = ThemeMethod.themeLight]) {
    SpUtils.saveString(_appThemeKey, _methodValues[themeMode]!);
    notifyListeners();
  }
  ...
  ThemeMode getThemeMode() {
    final String theme = SpUtils.getString(_appThemeKey) as String;
    switch (theme) {
      case _themeLight:
...
class MyThemes {
  static final lightTheme = ThemeData(
    primarySwatch: ColorUtils.materialColor(KColors.kThemeColor),
  ...
  static _m2ThemeData(Color themeColor, {bool isDarkMode = false}) {
    ...
    return ThemeData(
      useMaterial3: false,
      primarySwatch: ColorUtils.materialColor(themeColor),
      ...
      scaffoldBackgroundColor:
          isDarkMode ? KColors.kBgDarkColor : KColors.kBgColor,
